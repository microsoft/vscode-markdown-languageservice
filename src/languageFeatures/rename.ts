...
import { LsConfiguration, defaultMarkdownFileExtension } from '../config.js';
...
import { HrefKind, InternalHref, MdLink, MdLinkKind, MdLinkSource } from '../types/documentLink.js';
import { InMemoryDocument, tempDocVersion } from '../types/inMemoryDocument.js';
import { arePositionsEqual, translatePosition } from '../types/position.js';
